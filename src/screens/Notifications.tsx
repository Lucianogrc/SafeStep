...
export default function Notifications({ onBack }: NotificationsProps) {
  ...
  // 🔹 En el futuro aquí puedes traer notificaciones desde Firestore
  useEffect(() => {
    // Ejemplo: cargar desde Firestore según el usuario logueado
          ...
          <Animated.View entering={FadeInUp.duration(400)}>
            <View style={styles.emptyContainer}>
              <View style={styles.emptyCircle}>
                <Feather name="bell" size={40} color="#bbb" />
              </View>
              <Text style={styles.emptyTitle}>Sin notificaciones</Text>
              <Text style={styles.emptyText}>
                Aquí aparecerán tus alertas y actualizaciones cuando empieces a
                registrar tus visitas o conectar tu brazalete.
              </Text>
            </View>
          </Animated.View>
        ) : (
